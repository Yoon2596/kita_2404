...
#     title = db.Column(db.String(100), nullable=False)       # 길이 제한 있음
#     content = db.Column(db.Text, nullable=False)            # 길이 제한 없음
...
#     form = TaskForm(obj=task)       # task 객체를 초기화 (기존에 task에 해당하는 데이터를 폼에 채워넣음 )
