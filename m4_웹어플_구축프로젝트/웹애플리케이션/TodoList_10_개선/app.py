...
def task_list():
    ...
    return render_template(
        "task_list.html", tasks=tasks_with_info, current_date=current_date, checks=checks, search_query=search_query
    )
...
def admin():
    ...
    return render_template("admin.html", users=users, check=check, search_query=search_query)
