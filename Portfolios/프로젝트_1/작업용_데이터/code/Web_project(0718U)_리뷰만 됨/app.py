...
def map_view(id):
    ...
    if shop:
        ...
        # Convert reviews for nearby shops to a JSON serializable format
        nearby_shops_list = []
        for nearby_shop in nearby_shops:
            ...
            nearby_shops_list.append({
                ...
                "Description": nearby_shop.Description
            })

        return render_template('map.html', shopName=shopName, address=address, shopRate=shopRate, reviews=reviews,
                               price=price, description=description, category=category, user_reviews=user_reviews_list, nearby_shops=nearby_shops_list)
